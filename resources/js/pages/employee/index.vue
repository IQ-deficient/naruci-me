  ...
  <admin-layout>
    <v-banner class="mb-4">
      <div class="d-flex flex-wrap justify-space-between">
        <h5 class="text-h5 font-weight-bold">Pregled musterija sistema</h5>
    ...
    <div class="d-flex flex-wrap align-center">
      <v-text-field
        ...
        label="Pretraga korisnika po ID-u"
        single-line
        dense
        clearable
        hide-details
    ...
    <v-dialog v-model="dialogDelete" max-width="500">
      <v-card>
        <v-toolbar dense dark color="primary" class="text-h6  mb-4">Brisanje korisnika iz sistema
        </v-toolbar>
        <v-card-text class="text-h6">Da li ste sigurni da zelite da uklonite izabranog korisnika?</v-card-text>
        <v-card-actions>
          <v-spacer/>
          <v-btn :disabled="form.processing" text color="error" @click="dialogDelete = false">Odustani</v-btn>
          <v-btn :loading="form.processing" text color="primary" @click="destroy">Potvrdi</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </admin-layout>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: "Broj Telefona", value: "phone_number"},
        {text: "Vrijeme kreiranja profila", value: "created_at"},
        {text: "Vrijeme izmjene profila", value: "updated_at"},
        // {text: "Status", value: "status"},
        { text: "Uklanjanje korisnika", value: "action", sortable: false },
      ],
      breadcrumbs: [
        {
          text: "App",
